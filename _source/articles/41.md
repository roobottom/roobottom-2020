...
{% figure '/images/articles/[post]/alps.jpg', 'The road through the Alps from Austria to Italy. Beautiful mountains in the background.' %}
...
{% figure '/images/articles/[post]/france.jpg', 'Katie outside the van on our first night at Camping des Bruyeres, France' %}
...
{% figure '/images/articles/[post]/adam-night.jpg', 'View of the sunset over the lake at Campingplatz Adam, Germany' %}
...
{% figure '/images/articles/[post]/baden_lunch.jpg', 'Katie enjoying lunch outside at a restaurant in Baden-Baden' %}
...
{% figure '/images/articles/[post]/salzburg.jpg', 'A view of Saltzburg from a high vantage point just outside the city' %}
...
{% figure '/images/articles/[post]/pavilion.jpg', 'Katie outside the "Sixteen Going on Seventeen" pavilion made famous by the Sound of Music movie' %}
